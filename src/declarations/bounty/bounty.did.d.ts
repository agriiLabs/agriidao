...
export interface Bounty {
  ...
  'getUserCampaignsAccepted' : ActorMethod<[], Array<CampaignUser>>,
  'getUserCampaignsByUserId' : ActorMethod<[], Array<CampaignUser>>,
  'getUserCampaignsPending' : ActorMethod<[], Array<CampaignUser>>,
  'getUserCampaignsRejected' : ActorMethod<[], Array<CampaignUser>>,
